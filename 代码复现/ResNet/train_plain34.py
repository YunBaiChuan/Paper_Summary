...
from models.plain34 import Plain34
...
plt.tight_layout()
plt.savefig('res/Plain34_training_results.png', dpi=300, bbox_inches='tight')
plt.show()

print("\n✅ 结果已保存为 res/Plain34_training_results.png")